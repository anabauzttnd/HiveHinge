 ...
 * This file demonstrates how to integrate Hivehinge with a web frontend
 */

// For React/Vue/Angular applications
export class HivehingeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HivehingeClient(provider, contractAddress);
